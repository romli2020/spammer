...
def baner():
    print (''' 
  \033[32;1m╔════════════════════════════════════════════════╗
               \033[33;1mAUTHOR  :Faqih ID
               \033[33;1mFACEBOOK:Faqih ID
               \033[33;1mYoutube :Voodoboy
  \033[32;1m╚════════════════════════════════════════════════╝
...
if __name__=="__main__":
     try:
          ...
          baner()
          hh="+62"
          no=input("[+]\033[31;1mNOMOR TARGET: ")
          c=no[1:12]
          w=hh+c 
          kata("\033[31;1mPROSES SPAM SEDANG BERJALAN !"
          kata("===================================================")
          jenius()
          kata("\033[32;1mSPAM SUKSES FULL ✔")
          oyo()
          kata("\033[32;1mSPAM SUKSES FULL ✔")
          mapclub()
          kata("\033[32;1mSPAM SUKSES FULL ✔")
          ...
          kata("\033[32;1mSPAM SUKSES FULL ✔")
          time.sleep(5)
          kata("[●]\033[32;1mSpam Suksesfull..")
          kata("[+]\033[32;1mTERIMAKASIH SUDAH MENGUNAKAN SCRIPT INI..")
          balik()
     except KeyError:
             sys.exit()
